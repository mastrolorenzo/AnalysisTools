    ...
    if (m("twoResolvedJets")) {
       ...
       // }
        ...
        if (base2LepCSSelection) {
            if (////////////////////////// ttbar
                max_hJet_btag > taggerWP_T
                && min_hJet_btag > taggerWP_L
                && (V_mass > 10 && (V_mass < 75 || V_mass > 120))
            ) {
                *in["controlSample"] = 21;
            } else if (/////////////////// Z + LF
	        max_hJet_btag < taggerWP_L
                && min_hJet_btag < taggerWP_L
                && HVdPhi > 2.5
                ...
                for (int j = 0; j < (int) ptBoundL.size(); j++) {
                    for (int k = 0; k < (int) etaBoundL.size(); k++) {
                       if (m("Jet_Pt", i) < ptBoundH[j] && m("Jet_Pt", i) >= ptBoundL[j] && fabs(m("Jet_eta", i)) > etaBoundL[k] && fabs(m("Jet_eta", i)) <= etaBoundH[k]) {
                           ...
                           bTagWeightSys[Form("bTagWeight_LFUp_pt%i_eta%i",j,k)] *= bTagWeight_lfstats1_up;
                           bTagWeightSys[Form("bTagWeight_LFDown_pt%i_eta%i",j,k)] *= bTagWeight_lfstats1_down;
                           bTagWeightSys[Form("bTagWeight_LFStats1Up_pt%i_eta%i",j,k)] *= bTagWeight_lfstats2_up;
                           bTagWeightSys[Form("bTagWeight_LFStats1Down_pt%i_eta%i",j,k)] *= bTagWeight_lfstats2_down;
                           bTagWeightSys[Form("bTagWeight_LFStats2Up_pt%i_eta%i",j,k)] *= bTagWeight_lf_up;
                           bTagWeightSys[Form("bTagWeight_LFStats2Down_pt%i_eta%i",j,k)] *= bTagWeight_lf_down;
