...
parser.add_argument("--runOnSkim",          dest="runOnSkim",   default=1, type=int,              help="If 1 (default) run analysis jobs assuming the input files are already skimmed by AT, if 0 assume running directly on post-processed NanoAOD. If doSkim is 1 then this variable is assumed to be always 0.")
