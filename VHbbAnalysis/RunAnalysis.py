...
if (args.runBatch == False):
    ...
    if args.site == "DESY":
        ...
        inputs_to_transfer.remove('../python/TensorflowEvaluatorSummer2018.py')
        inputs_to_transfer.remove('../python/TensorflowDNNClassifierSummer2018.py')
        ...
        inputs_to_transfer.append('../TensorflowEvaluatorSummer2018.py')
        inputs_to_transfer.append('../TensorflowDNNClassifierSummer2018.py')
