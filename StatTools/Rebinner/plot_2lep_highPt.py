...
class Plotter(object):
    ...
    def get_stack(self, bin_edges):
        ...
        histograms['W+Jets'] = self.get_histogram('WJets', bin_edges, 'weight * (bin_index_Zll_highPt>-1)')
...
def main():
    ...
    best_bin_edges = {
        'asimov': [-1, 0.25328847765922546, 0.47942841053009033, 0.6295876502990723, 1,
        'poisson': [-1, 0.25328847765922546, 0.47942841053009033, 0.6295876502990723, 1],
    }

    best_significance = {
        'asimov': 1.4069520445429697,
        'poisson': 1.4462364974563349,
    }
