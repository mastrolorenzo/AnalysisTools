...
input_pattern = '/eos/uscms/store/group/lpchbb/VHbbAnalysisNtuples/2017V5_June3_FREEZING/sum_%s*.root'
...
def get_samples(channel, signal_overlay=False, **kwargs):
    ...
    **kwargs
    ...
    samples = {
        'ST_s':           [16, 1., 'Single top', ['ST_s-c_4f_lep_PSw']],
        'ST_t_antitop':   [19, 1., 'Single top', ['ST_t-c_antitop_4f_inc']],
        'ST_t_top':       [18, 1., 'Single top', ['ST_t-c_top_4f_inc']],
    ...
    if channel == 'Zll':
        samples.update({
            ...
            'DYToLL_HT100to200_madgraph_udcsg':   ['sampleIndex%100==0', sf_zj0b, 'Z+udcsg',    ['DYToLL_HT100to200_madgraph']],
            'DYToLL_HT100to200_madgraph_b':       ['sampleIndex%100==1', sf_zj1b, 'Z+b',        ['DYToLL_HT100to200_madgraph']],
            'DYToLL_HT100to200_madgraph_bb':      ['sampleIndex%100==2', sf_zj2b, 'Z+b#bar{b}', ['DYToLL_HT100to200_madgraph']],
            ...
            'DYToLL_HT400to600_madgraph_udcsg':   ['sampleIndex%100==0', sf_zj0b, 'Z+udcsg',    ['DYToLL_HT400to600_madgraph']],
            'DYToLL_HT400to600_madgraph_b':       ['sampleIndex%100==1', sf_zj1b, 'Z+b',        ['DYToLL_HT400to600_madgraph']],
            'DYToLL_HT400to600_madgraph_bb':      ['sampleIndex%100==2', sf_zj2b, 'Z+b#bar{b}', ['DYToLL_HT400to600_madgraph']],
            'DYToLL_HT600to800_madgraph_udcsg':   ['sampleIndex%100==0', sf_zj0b, 'Z+udcsg',    ['DYToLL_HT600to800_madgraph']],
            'DYToLL_HT600to800_madgraph_b':       ['sampleIndex%100==1', sf_zj1b, 'Z+b',        ['DYToLL_HT600to800_madgraph']],
            'DYToLL_HT600to800_madgraph_bb':      ['sampleIndex%100==2', sf_zj2b, 'Z+b#bar{b}', ['DYToLL_HT600to800_madgraph']],
            'DYToLL_HT800to1200_madgraph_udcsg':  ['sampleIndex%100==0', sf_zj0b, 'Z+udcsg',    ['DYToLL_HT800to1200_madgraph']],
            'DYToLL_HT800to1200_madgraph_b':      ['sampleIndex%100==1', sf_zj1b, 'Z+b',        ['DYToLL_HT800to1200_madgraph']],
            'DYToLL_HT800to1200_madgraph_bb':     ['sampleIndex%100==2', sf_zj2b, 'Z+b#bar{b}', ['DYToLL_HT800to1200_madgraph']],
