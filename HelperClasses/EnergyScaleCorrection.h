...
public:
  ...
  {
  public:
    CorrectionCategory(const std::string& category="NONE",int runnrMin=0,int runnrMax=999999);
...
public:
  ...
  float scaleCorrkErrStatSystGain(unsigned int runnr, double et, double eta, double r9,
		  unsigned int gainSeed=12) const {
      return scaleCorr(runnr, et, eta, r9, gainSeed, kErrStatSystGain);
  }
  ...
  float scaleCorrUncertkErrStatSystGain(unsigned int runnr, double et, double eta, double r9,
      unsigned int gainSeed) const {
      return scaleCorrUncert(runnr, et, eta, r9, gainSeed, kErrStatSystGain);
  }
