...
AnalysisDict.cxx: HelperClasses/SampleContainer.h HelperClasses/InfoStructs.h HelperClasses/BDTInfo.h HelperClasses/BDTVariable.h HelperClasses/SystematicContainer.h HelperClasses/SFContainer.h AnalysisManager.h plugins/VHbbAnalysis.h plugins/VHbbTrigger.h plugins/EWKAnalysis.h HelperClasses/BTagCalibrationStandalone.h LinkDef.h
	rootcint -f $@ -c $^
...
AnalysisDict.so: AnalysisDict.cxx HelperClasses/SampleContainer.cc HelperClasses/BDTInfo.cc HelperClasses/BDTVariable.cc HelperClasses/SystematicContainer.cc HelperClasses/SFContainer.cc AnalysisManager.cc plugins/VHbbAnalysis.cc plugins/VHbbTrigger.cc plugins/EWKAnalysis.cc HelperClasses/EquationSolver.h HelperClasses/BTagCalibrationStandalone.cpp
	g++ -shared -fPIC -g -Wall -o $@ ${ROOTFLAGS} ${ROOTLIBS} -lTMVA -I${HOMEDIR} $^
